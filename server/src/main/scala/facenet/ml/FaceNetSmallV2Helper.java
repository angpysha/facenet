...
import static facenet.ml.FaceNetSmallV2Model.paddingIndex;
import static facenet.ml.FaceNetSmallV2Model.reluIndex;

public class FaceNetSmallV2Helper {
  static final String BASE = "./models/face/";
  ...
  static double[] readWightsValues(String path) throws IOException {
    ...
    String collect = Files.lines(Paths.get(path)).collect(Collectors.joining(","));
